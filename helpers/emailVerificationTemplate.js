function  emailVerificationTempalte(token){
 ...
 <a href="http://localhost:3000/api/v1/authtication/emailverification/${token}" style="text-decoration:none;padding:10px 20px;background-color:#262626;color:#f0f8ff;font-size:14px;font-weight:700">Confirm Your Email</a>
 </div>`
}
